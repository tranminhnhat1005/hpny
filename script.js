...
// Greeting dictionary: country code → localized "I Like You"
const NEW_YEAR_GREETINGS = {
	...
	IN: 'मुझे तुम पसंद हो',
	PK: 'مجھے تم پسند ہو',
	BD: 'আমি তোমাকে পছন্দ করি',
	LK: 'මම ඔයාට කැමතියි',
	NP: 'मलाई तिमी मन पर्छ',
	// Middle East & Central Asia
	SA: 'أنا أحبك',
	AE: 'أنا أحبك',
	EG: 'أنا بحبك',
	IQ: 'أنا أحبك',
	IR: 'من تو را دوست دارم',
	TR: 'Senden Hoşlanıyorum',
	IL: 'אני אוהב אותך',
	// Europe — Western
	US: 'I Like You',
	GB: 'I Like You',
	...
	DK: 'Jeg Kan Lide Dig',
	FI: 'Pidän Sinusta',
	IS: 'Mér Líkar Við Þig',
	// Europe — Eastern
	RU: 'Ты Мне Нравишься',
	UA: 'Ти Мені Подобаєшся',
	PL: 'Lubię Cię',
	CZ: 'Líbíš Se Mi',
	SK: 'Páčiš Sa Mi',
	HU: 'Tetszik Nekem',
...
const DEFAULT_GREETING = 'Anh Thích Em';
